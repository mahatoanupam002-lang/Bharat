...
export const S = {
  ...
  mythBox: { background: "rgba(224,138,90,.07)", border: "1px solid rgba(224,138,90,.28)", borderRadius: 14, padding: "20px 22px", margin: "32px 0" },
  mythLabel: { fontSize: 11, letterSpacing: 2, color: "#e08a5a", fontWeight: 600, textTransform: "uppercase", marginBottom: 8 },
  mythClaim: { fontSize: 16, lineHeight: 1.55, color: "#e9c9b4", fontFamily: serif, fontStyle: "italic", marginBottom: 16 },
  mythLabelTrue: { fontSize: 11, letterSpacing: 2, color: "#7bb86f", fontWeight: 600, textTransform: "uppercase", marginBottom: 8 },
  sourcesBox: { marginTop: 40, borderTop: "1px solid rgba(243,234,217,.1)", paddingTop: 22 },
  sourcesLabel: { fontSize: 11, letterSpacing: 2, color: muted, fontWeight: 600, textTransform: "uppercase", marginBottom: 14 },
  sourcesList: { listStyle: "none", display: "flex", flexDirection: "column", gap: 10 },
  sourcesItem: { fontSize: 14, lineHeight: 1.5 },
  sourcesLink: { color: "#cfc4b0", textDecoration: "none", borderBottom: "1px solid rgba(243,234,217,.2)" },
